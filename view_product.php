      ...
      <div class="panel-body">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div><label>Omschrijving:</label></div>
              ...
              <table class="table table-bordered">
                <thead>
                  <tr>
                    ...
                    <th class="text-center" style="width: 15%;"> Prijs </th>
                    <th class="text-center" style="width: 15%;"> Datum toegevoegd </th>
                    <th class="text-center" style="width: 50px;"> Acties </th>
                  </tr>
                  <!--     *************************     -->
                </thead>
                <tbody>
