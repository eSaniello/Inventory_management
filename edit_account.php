    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <div class="panel-heading clearfix">
          ...
          <span>Mijn foto veranderen</span>
        </div>
      </div>
          ...
          <div class="col-md-8">
            <form class="form" action="edit_account.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                ...
                <button type="submit" name="submit" class="btn btn-warning">Verander</button>
              </div>
            </form>
          </div>
        </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading clearfix">
        ...
        <span>Mijn account wijzigen</span>
      </div>
      <div class="panel-body">
        <form method="post" action="edit_account.php?id=<?php echo (int)$user['id']; ?>" class="clearfix">
          ...
          <div class="form-group clearfix">
            <a href="change_password.php" title="change password" class="btn btn-danger pull-right">Wachtwoord veranderen</a>
